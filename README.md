...
I'm a 16-year-old computer programmer. Despite the fact that I am still in high school, I wanted to create something really cool that could help a lot of people be more efficient. My main project is a Python-coded Discord bot. For now, I only code in Python, but in the future I'm planning to learn and use more languages in my projects!
...
- [`GanyuBot`]('https://github.com/Cedrugs/Custom-Discord-RPC') - A bot created to help people with genshin impact things such as wish history and in-game information.
